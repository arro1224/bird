...
class CurrentBatchCard extends StatelessWidget {
  const CurrentBatchCard({super.key, required this.batch, required this.onOpen, this.onBrowseScenes, this.actionLabel = '进入当前批次', this.contextLabel = '当前批次'});
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FilledButton(onPressed: onOpen, child: Text(actionLabel)),
          ),
        ],
      ),
    ),
...
class _Count extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      Text(label, maxLines: 1, style: const TextStyle(color: AppColors.inkMuted, fontSize: 11)),
